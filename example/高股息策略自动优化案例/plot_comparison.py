...
optimization_labels = {
    ...
    'opt12_combined_biweekly_15': '组合优化',
}
...
order = [
    ...
    'opt02_stop_loss',
    'opt03_roe_threshold',
    'opt04_profit_growth_threshold',
    'opt05_cashflow_threshold',
    'opt06_biweekly_rebalance',
    'opt07_quarterly_rebalance',
    'opt08_dividend_stability',
    'opt09_max_stocks_15',
    'opt10_max_stocks_30',
    'opt12_combined_biweekly_15',
]
...
baseline_sharpe = results.get('baseline', {}).get('sharpe_ratio', 1.4053)
...
for key in order:
    ...
    elif key == 'opt12_combined_biweekly_15':
...
fig.suptitle('高股息策略优化对比分析', fontsize=18, fontweight='bold', y=0.98)
